...
import './styles.css';
import { LineChart, Label, AreaChart, Area, Line, CartesianGrid,XAxis, YAxis, Tooltip, Legend} from 'recharts';
...
export default  class TopCharts extends Component{
    ...
    componentDidMount() {
     ...
     areaChart(color,yKey,yLabel, height, title){
     ...
     render () {
        ...
        return (
            ...
            {this.lineChart(Colors.positive, "positive", "Total Positives", chartHeightTotals, "Positive Cases")}
            {this.lineChart(Colors.death, "death", "Total Deaths", chartHeightTotals,"Deaths")}
            </div>

            <div className='row-components'>            
            {this.areaChart(Colors.positive, "positiveIncrease", "Positives per Day",chartHeightPerDay)}
            {this.areaChart(Colors.death, "deathIncrease", "Deaths per Day",chartHeightPerDay)}
            </div>
